...
object TransactionGen extends TransactionGen

trait TransactionGen extends TransactionGenBase

trait TransactionGenBase extends ScriptGen with NTPTime {
  val ENOUGH_AMT = Long.MaxValue / 3
  ...
  import com.wavesplatform.state.DataEntry.MaxKeySize
